...
{% include figure.html path="assets/img/mapgen.png" class="img-fluid rounded mx-auto d-block z-depth-1" width=500 zoomable=true%}
<div class="caption">
    Map generation displayed at startup.
</div>

{% include figure.html path="assets/img/cave_map_with_tooltip.png" class="img-fluid rounded mx-auto d-block z-depth-1" width=500 zoomable=true%}
<div class="caption">
