...
As part of the Edmonds College Physics Department, I completed a quarter-long undergraduate research project exploring the quantum properties of optical networks in Spring 2023. I was curious if there was a point when information loss would become indistinguishable from detection of an eavesdropper. I created a poster to present my findings at the Edmonds College Undergraduate Research Symposium in June of 2023. A final research paper typeset with LaTeX provided a detailed outline of the methodology, findings, and data.
